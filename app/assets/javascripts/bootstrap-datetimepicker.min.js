...
(function ($) {
        ...
        constructor: DateTimePicker, init: function (element, options) {
            ...
            if (!this.isInput) {
                if (this.component) {
                    ...
                    //time_array = formatted.split(':')
                    //if(time_array.length > 2){
                    //    time_array[2] = (time_array[2] + " Seconds ")
                    //    time_array[1] = (time_array[1] + " Minutes ")
                    //    time_array[0] = (time_array[0] + " Hours ")
                    //}else if (time_array.length > 1) {
                    //    time_array[1] = (time_array[1] + " Minutes ")
                    //    time_array[0] = (time_array[0] + " Hours ")
                    //}
                    //formatted = time_array.join(':')
            ...
            timeComponents.filter("[data-time-component=hours]").text(hour + " Hours");
            timeComponents.filter("[data-time-component=minutes]").text(minute + " Minutes");
            timeComponents.filter("[data-time-component=seconds]").text(second + " Seconds")
        }, click: function (e) {
            e.stopPropagation();
            e.preventDefault();
            this._unset = false;
    ...
    TPGlobal.getTemplate = function (is12Hours, showSeconds) {
        return '<div class="timepicker-picker">' + '<table class="table-condensed" border="0"' + (is12Hours ? ' data-hour-format="12"' : "") + ">" + "<tr>" + "<td style='border-right: 0; border-left: 0'><a href='#' class='btn' data-action='incrementHours' style='padding: 2px'><i class='fa fa-chevron-up'></i></a></td>" + "<td class='separator'></td>" + '<td style="border-right: 0; border-left: 0"><a href="#" class="btn" data-action="incrementMinutes" style="padding: 2px"><i class="fa fa-chevron-up"></i></a></td>' + (showSeconds ? '<td class="separator"></td>' + '<td style="border-right: 0; border-left: 0"><a href="#" class="btn" data-action="incrementSeconds" style="padding: 2px"><i class="fa fa-chevron-up"></i></a></td>' : "") + (is12Hours ? '<td class="separator"></td>' : "") + "</tr>" + "<tr>" + '<td style="border-right: 0; border-left: 0">' + TPGlobal.hourTemplate + "</td> " + '<td class="separator">:</td>' + '<td style="border-right: 0; border-left: 0">' + TPGlobal.minuteTemplate + "</td> " + (showSeconds ? '<td class="separator">:</td>' + '<td style="border-right: 0; border-left: 0">' + TPGlobal.secondTemplate + "</td>" : "") + (is12Hours ? '<td class="separator"></td>' + '<td style="border-right: 0; border-left: 0">' + '<button type="button" class="btn btn-danger" data-action="togglePeriod"></button>' + "</td>" : "") + "</tr>" + "<tr>" + '<td style="border-right: 0; border-left: 0"><a href="#" class="btn" data-action="decrementHours" style="padding: 2px"><i class="fa fa-chevron-down"></i></a></td>' + '<td class="separator"></td>' + '<td style="border-right: 0; border-left: 0"><a href="#" class="btn" data-action="decrementMinutes" style="padding: 2px"><i class="fa fa-chevron-down"></i></a></td>' + (showSeconds ? '<td class="separator"></td>' + '<td style="border-right: 0; border-left: 0"><a href="#" class="btn" data-action="decrementSeconds" style="padding: 2px"><i class="fa fa-chevron-down"></i></a></td>' : "") + (is12Hours ? '<td class="separator"></td>' : "") + "</tr>" + "</table>" + "</div>" + '<div class="timepicker-hours" data-action="selectHour">' + '<table class="table-condensed">' + "</table>" + "</div>" + '<div class="timepicker-minutes" data-action="selectMinute">' + '<table class="table-condensed">' + "</table>" + "</div>" + (showSeconds ? '<div class="timepicker-seconds" data-action="selectSecond">' + '<table class="table-condensed">' + "</table>" + "</div>" : "")
    }
})(window.jQuery);
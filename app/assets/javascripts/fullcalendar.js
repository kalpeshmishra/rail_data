...
(function ($, undefined) {
    ...
    var defaults = {
        ...
        buttonText: {
            ...
            next: "<span class='fc-text-arrow'><i class='fa fa-angle-right'></span>",
            prevYear: "<span class='fc-text-arrow'><i class='fa fa-angle-left'></span>",
            nextYear: "<span class='fc-text-arrow'><i class='fa fa-angle-right'></span>",
            today: 'today',
            month: 'month',
            week: 'week',
            day: 'day'
...
// right-to-left defaults
    var rtlDefaults = {
        ...
        buttonText: {
            prev: "<span class='fc-text-arrow'><i class='fa fa-angle-right'></i></span>",
            next: "<span class='fc-text-arrow'><i class='fa fa-angle-left'></i></span>",
            prevYear: "<span class='fc-text-arrow'><i class='fa fa-angle-right'></i></span>",
            nextYear: "<span class='fc-text-arrow'><i class='fa fa-angle-left'></i></span>"
        },
        buttonIcons: {
    ...
    function Header(calendar, options) {
        ...
        function render() {
            ...
            if (sections) {
                ...
                //);
                element = $("<div class='row no-margin' />")
                    .append(renderSection('left'))
                    .append(renderSection('right'));
                return element;
            }
        ...
        function renderSection(position) {
            ...
            var e = $("<div class='col-xs-12 col-sm-6 col-md-6 col-lg-6 fc-header-" + position + "'/>");
                    ...
                    $.each(this.split(','), function (j, buttonName) {
                        if (buttonName == 'title') {
                            ...
                            if (buttonClick) {
                                ...
                                var button = $(
                                    "<span class='btn fc-button fc-button-" + buttonName + " " + tm + "-state-default'>" +
                                    (icon ?
